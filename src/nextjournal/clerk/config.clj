...
(def default-resource-manifest
  {"/js/viewer.js" "https://storage.googleapis.com/nextjournal-cas-eu/data/8VtyNscqc4pUVwVFjrtePhGdkSFBvPJJacmNZyZaG676gVWQjPQBdHFJzmjMWyckqsZeaCG9AutfQSXCPKiybjxbhj"})

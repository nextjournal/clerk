...
(def default-resource-manifest
  {"/js/viewer.js" "https://storage.googleapis.com/nextjournal-cas-eu/data/8VwpGbuAxBK6V1WFdfUrCfgU6N2cuQehEdajRoNWNGRmC3Rt2bTN7RgjiYr2rngAEoBT7nbrtfbcELfoq92sapQka8"})
